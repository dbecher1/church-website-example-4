...
{#snippet mass_and_service()}
    <div class='flex w-full px-12 py-4 justify-around'>
        <img src='/rosary.jpg' alt='Rosary' class=''/>
        <div class='w-xl my-auto'>
...
{#snippet banner(text: string, bg: string)}
    <div class='w-full bg-base-300/50 py-12 font-formal text-center text-6xl text-shadow-sm text-shadow-black/30 border-[1px] border-secondary/10'>
...
{#snippet event_card({name, details, info_href, href, src}: EventInfo)}
    <div class='card bg-neutral w-96 h-128 p-4 shadow-sm transform hover:shadow-lg hover:scale-105'>
        <figure>
